...
print(f"DEBUG: Loaded BASE_URL: {os.environ.get('BASE_URL')}")
print(f"DEBUG: Loaded GITHUB_CLIENT_ID: {os.environ.get('GITHUB_CLIENT_ID')}")

app = Flask(__name__)

#GitHub OAuth configuration
app.config['GITHUB_CLIENT_ID'] = os.environ.get('GITHUB_CLIENT_ID', 'your-client-id')
app.config['GITHUB_CLIENT_SECRET'] = os.environ.get('GITHUB_CLIENT_SECRET', 'your-client-secret')
# Database configuration
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///gitdone.db'
...
def create_goal():
    ...
    webhook_secret = app.config['SECRET_KEY']
...
def embed_widget(token):
    ...
    return render_template('embed.html', goal=goal)

@app.route('/api/embed/<token>/data')
